...
void   mad_vec_minmax (const  num_t x[],        log_t absf     ,  idx_t r[2], ssz_t n, ssz_t d); // MinMax(vec)
...
void   mad_cvec_reim  (const cnum_t x[],        num_t re[]     ,  num_t ri[], ssz_t n, ssz_t d); //  cvec->vr,vi
void   mad_cvec_conj  (const cnum_t x[],                         cnum_t  r[], ssz_t n, ssz_t d); //  cvec ->cvec*
void   mad_cvec_abs   (const cnum_t x[],                          num_t  r[], ssz_t n, ssz_t d); // |cvec_i|
...
void   mad_ivec_mul   (const  idx_t x[], const  idx_t y[]      ,  idx_t  r[], ssz_t n, ssz_t d); // ivec * ivec
