...
num_t  mad_vec_norm   (const  num_t x[]                                     , size_t n); // |vec|
num_t  mad_vec_dist   (const  num_t x[], const   num_t y[]                  , size_t n); // |vec -  vec|
num_t  mad_vec_distv  (const  num_t x[], const  cnum_t y[]                  , size_t n); // |vec - cvec|
...
num_t  mad_cvec_norm  (const cnum_t x[]                                     , size_t n); // |cvec|
num_t  mad_cvec_dist  (const cnum_t x[], const cnum_t y[]                   , size_t n); // |cvec - cvec|
num_t  mad_cvec_distv (const cnum_t x[], const  num_t y[]                   , size_t n); // |cvec -  vec|
...
void   mad_cvec_irfft (const cnum_t x[],                          num_t  r[], size_t n); //  cvec -> vec
