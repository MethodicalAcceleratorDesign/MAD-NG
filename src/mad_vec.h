...
void   mad_vec_nfft   (const  num_t x[], const num_t r_node[]  , cnum_t  r[], ssz_t nx, ssz_t nr);
...
void   mad_cvec_nfft  (const cnum_t x[], const num_t r_node[]  , cnum_t  r[], ssz_t nx, ssz_t nr);
void   mad_cvec_ifft  (const cnum_t x[],                         cnum_t  r[], ssz_t n); //  cvec ->cvec
void   mad_cvec_irfft (const cnum_t x[],                          num_t  r[], ssz_t n); //  cvec -> vec
void   mad_cvec_infft (const cnum_t x[], const num_t x_node[]  , cnum_t  r[], ssz_t nx, ssz_t nr);
