...
module GTPSA
  ...
  interface
    ...
    integer(c_int32_t) function mad_mono_str(n,mono_a,s) bind(C)
      use, intrinsic :: iso_c_binding
      integer(c_int32_t), value, intent(in) :: n  ! monomial and string length
    ...
    subroutine mad_mono_fill(n,mono_a,v) bind(C)
      use, intrinsic :: iso_c_binding
      integer(c_int32_t), value, intent(in) :: n     ! monomial length
      integer(c_signed_char) :: mono_a(*)            ! monomial
      integer(c_signed_char), value, intent(in) :: v ! value
    end subroutine mad_mono_fill

    subroutine mad_mono_copy(n,mono_a,mono_r) bind(C)
      use, intrinsic :: iso_c_binding
      integer(c_int32_t), value, intent(in) :: n      ! monomials lengths
    ...
    subroutine mad_mono_concat(na,mono_a,nb,mono_b,mono_r) bind(C)
      use, intrinsic :: iso_c_binding
      integer(c_int32_t), value, intent(in) :: na, nb ! monomials lengths
      integer(c_signed_char), intent(in) :: mono_a(*),  mono_b(*) ! src
  ...
  interface
    ...
    type(c_ptr) function mad_desc_newn(nmv,nmo) bind(C)
      ...
      integer(c_signed_char), value, intent(in) :: nmo ! order of map_vars
    ...
    type(c_ptr) function mad_desc_newk(nmv,nmo,nk,ko,dk) bind(C)
      ...
      integer(c_signed_char), value, intent(in) :: nmo, ko, dk ! order of map_vars, knobs and across knobs
    ...
    type(c_ptr) function mad_desc_newv(nmv,mvar_ords,nv,var_ords,dk) bind(C)
      ...
      integer(c_signed_char), value, intent(in) :: dk    ! max order across knobs
    ...
    integer(c_int32_t) function mad_desc_ordlen(desc,mo) bind(C)
      use, intrinsic :: iso_c_binding
      type(c_ptr), value, intent(in) :: desc
      integer(c_signed_char), value, intent(in) :: mo ! ordlen(maxord) == maxlen
    ...
    integer(c_signed_char) function mad_desc_gtrunc(desc,to) bind(C)
      ...
      integer(c_signed_char), value, intent(in) :: to ! global truncation order
  ...
  interface
    ...
    type(c_ptr) function mad_tpsa_newd(desc,mo) bind(C)
      use, intrinsic :: iso_c_binding
      type(c_ptr), value, intent(in) :: desc
      integer(c_signed_char), value, intent(in) :: mo ! if mo > d_mo, mo = d_mo
    ...
    integer(c_signed_char) function mad_tpsa_ordn(n,tpsa) bind(C)
      use, intrinsic :: iso_c_binding
      integer(c_int32_t), value, intent(in) :: n  ! #tpsa
    ...
    subroutine mad_tpsa_convert(tpsa,tpsa_r,n,t2r) bind(C)
      ...
      type(c_ptr), value, intent(in) :: tpsa     ! src
      type(c_ptr), value :: tpsa_r               ! dst
      integer(c_int32_t), value, intent(in) :: n ! vector length
    ...
    subroutine mad_tpsa_scalar(tpsa,v,iv,scl) bind(C)
      use, intrinsic :: iso_c_binding
      type(c_ptr), value :: tpsa
      real(c_double), value, intent(in) :: v, scl  ! 0 and 1st order values
      integer(c_int32_t), value, intent(in) :: iv  ! variable index (1st order)
    ...
    integer(c_signed_char) function mad_tpsa_mono(tpsa,n,m,i) bind(C)
      use, intrinsic :: iso_c_binding
      type(c_ptr), value, intent(in) :: tpsa
      integer(c_int32_t), value, intent(in) :: n, i ! monomial length, slot index
    ...
    integer(c_int32_t) function mad_tpsa_idxs(tpsa,n,s) bind(C)
      use, intrinsic :: iso_c_binding
      type(c_ptr), value, intent(in) :: tpsa
      integer(c_int32_t), value, intent(in) :: n ! string length or 0 (unknown)
      character(c_char), intent(in) :: s(*)      ! monomial as string "[0-9]*"
    ...
    real(c_double) function mad_tpsa_geti(tpsa,i) bind(C)
      use, intrinsic :: iso_c_binding
      type(c_ptr), value, intent(in) :: tpsa
      integer(c_int32_t), value, intent(in) :: i ! slot index
    ...
    subroutine mad_tpsa_getv(tpsa,i,n,v) bind(C)
      use, intrinsic :: iso_c_binding
      type(c_ptr), value, intent(in) :: tpsa
      integer(c_int32_t), value, intent(in) :: i, n  ! slot index, vector length
    ...
    subroutine mad_tpsa_set0(tpsa,a,b) bind(C)
      use, intrinsic :: iso_c_binding
      type(c_ptr), value :: tpsa
      real(c_double), value, intent(in) :: a, b ! t[0] = a*t[0]+b
    ...
    subroutine mad_tpsa_seti(tpsa,i,a,b) bind(C)
      ...
      type(c_ptr), value :: tpsa
      integer(c_int32_t), value, intent(in) :: i ! slot index
      real(c_double), value, intent(in) :: a, b  ! t[i] = a*t[i]+b
    ...
    subroutine mad_tpsa_sets(tpsa,n,s,a,b) bind(C)
      ...
      integer(c_int32_t), value, intent(in) :: n ! string length or 0 (unknown)
      character(c_char), intent(in) :: s(*)      ! monomial as string "[0-9]*"
      real(c_double), value, intent(in) :: a, b  ! t[s] = a*t[s]+b
    ...
    subroutine mad_tpsa_setm(tpsa,n,m,a,b) bind(C)
      ...
      integer(c_int32_t), value, intent(in) :: n ! monomial length
      integer(c_signed_char), intent(in) :: m(*) ! monomial
      real(c_double), value, intent(in) :: a, b  ! t[m] = a*t[m]+b
    ...
    logical(c_bool) function mad_tpsa_equ(tpsa_a,tpsa_b,eps) bind(C)
      ...
      real(c_double), value, intent(in) :: eps  ! tolerance during comparison
    ...
    subroutine mad_tpsa_powi(tpsa_a,n,tpsa_r) bind(C)
      ...
      integer(c_int32_t), value, intent(in) :: n ! power (integer)
      type(c_ptr), value :: tpsa_r               ! dst
    ...
    subroutine mad_tpsa_pown(tpsa_a,v,tpsa_r) bind(C)
      use, intrinsic :: iso_c_binding
      type(c_ptr), value, intent(in) :: tpsa_a   ! src
      real(c_double), value, intent(in) :: v     ! power (real)
      type(c_ptr), value :: tpsa_r               ! dst
    ...
    subroutine mad_tpsa_poisson(tpsa_a,tpsa_b,tpsa_r,nv) bind(C)
      ...
      type(c_ptr), value :: tpsa_r                     ! dst
      integer(c_int32_t), value, intent(in) :: nv    ! #variables (desc%nv if 0)
    ...
    subroutine mad_tpsa_acc(tpsa_a,v,tpsa_r) bind(C)
      ...
      real(c_double), value, intent(in) :: v      ! r = r + v*a (r not reset!)
    ...
    subroutine mad_tpsa_scl(tpsa_a,v,tpsa_r) bind(C)
      ...
      type(c_ptr), value, intent(in) :: tpsa_a    ! src
      type(c_ptr), value :: tpsa_r                ! dst
      real(c_double), value, intent(in) :: v      ! r = v*a
    ...
    subroutine mad_tpsa_invsqrt(tpsa_a,v,tpsa_r) bind(C)
      ...
      type(c_ptr), value, intent(in) :: tpsa_a    ! src
      type(c_ptr), value :: tpsa_r                ! dst
      real(c_double), value, intent(in) :: v      ! r = v/sqrt(a)
    ...
    subroutine mad_tpsa_axpb(a,tpsa_x,b,tpsa_r) bind(C)
      use, intrinsic :: iso_c_binding
      real(c_double), value, intent(in) :: a, b   ! coefs
    ...
    subroutine mad_tpsa_axpbypc(a,tpsa_x,b,tpsa_y,c,tpsa_r) bind(C)
      use, intrinsic :: iso_c_binding
      real(c_double), value, intent(in) :: a, b, c      ! coefs
    ...
    subroutine mad_tpsa_minv(n,tpsa_a,tpsa_r) bind(C)
      use, intrinsic :: iso_c_binding
      integer(c_int32_t), value, intent(in) :: n      ! vectors lengths
    ...
    subroutine mad_tpsa_compose(na,tpsa_a,nb,tpsa_b,tpsa_r) bind(C)
      use, intrinsic :: iso_c_binding
      integer(c_int32_t), value, intent(in) :: na, nb ! vectors lengths
    ...
    subroutine mad_tpsa_print(tpsa,name_,eps_,stream_) bind(C)
      ...
      real(c_double), value, intent(in) :: eps_ ! display precision, e.g. 1e-12
  ...
  interface
    ...
    integer(c_signed_char) function mad_ctpsa_ordn(n,ctpsa) bind(C)
      use, intrinsic :: iso_c_binding
      integer(c_int32_t), value, intent(in) :: n ! #ctpsa
    ...
    subroutine mad_ctpsa_scalar(ctpsa,v,iv,scl) bind(C)
      use, intrinsic :: iso_c_binding
      type(c_ptr), value :: ctpsa
      complex(c_double_complex), value, intent(in) :: v, scl  ! 0 and 1st order values
      integer(c_int32_t), value, intent(in) :: iv  ! variable index (1st order)
    ...
    subroutine mad_ctpsa_set0(ctpsa,a,b) bind(C)
      use, intrinsic :: iso_c_binding
      type(c_ptr), value :: ctpsa
      complex(c_double_complex), value, intent(in) :: a, b ! ct[0] = a*ct[0]+b
    ...
    subroutine mad_ctpsa_seti(ctpsa,i,a,b) bind(C)
      ...
      type(c_ptr), value :: ctpsa
      integer(c_int32_t), value, intent(in) :: i            ! slot index
      complex(c_double_complex), value, intent(in) :: a, b  ! ct[i] = a*ct[i]+b
    ...
    subroutine mad_ctpsa_sets(ctpsa,n,s,a,b) bind(C)
      ...
      integer(c_int32_t), value, intent(in) :: n ! string length or 0 (unknown)
      character(c_char), intent(in) :: s(*)      ! monomial as string "[0-9]*"
      complex(c_double_complex), value, intent(in) :: a, b  ! ct[s] = a*ct[s]+b
    ...
    subroutine mad_ctpsa_setm(ctpsa,n,m,a,b) bind(C)
      ...
      integer(c_int32_t), value, intent(in) :: n ! monomial length
      integer(c_signed_char), intent(in) :: m(*) ! monomial
      complex(c_double_complex), value, intent(in) :: a, b ! ct[m] = a*ct[m]+b
    ...
    subroutine mad_ctpsa_pown(ctpsa_a,v,ctpsa_r) bind(C)
      use, intrinsic :: iso_c_binding
      type(c_ptr), value, intent(in) :: ctpsa_a         ! src
      complex(c_double_complex), value, intent(in) :: v ! power (real)
      type(c_ptr), value :: ctpsa_r                     ! dst
    ...
    subroutine mad_ctpsa_acc(ctpsa_a,v,ctpsa_r) bind(C)
      ...
      complex(c_double_complex), value, intent(in) :: v ! r = r+v*a
    ...
    subroutine mad_ctpsa_scl(ctpsa_a,v,ctpsa_r) bind(C)
      ...
      type(c_ptr), value, intent(in) :: ctpsa_a          ! src
      type(c_ptr), value :: ctpsa_r                      ! dst
      complex(c_double_complex), value, intent(in) :: v  ! r = v*a
    ...
    subroutine mad_ctpsa_invsqrt(ctpsa_a,v,ctpsa_r) bind(C)
      ...
      type(c_ptr), value, intent(in) :: ctpsa_a          ! src
      type(c_ptr), value :: ctpsa_r                      ! dst
      complex(c_double_complex), value, intent(in) :: v  ! r = v/sqrt(a)
    ...
    subroutine mad_ctpsa_axpb(a,ctpsa_x,b,ctpsa_r) bind(C)
      use, intrinsic :: iso_c_binding
      complex(c_double_complex), value, intent(in) :: a, b ! coefs
    ...
    subroutine mad_ctpsa_axpbypc(a,ctpsa_x,b,ctpsa_y,c,ctpsa_r) bind(C)
      use, intrinsic :: iso_c_binding
      complex(c_double_complex), value, intent(in) :: a, b, c ! coefs
