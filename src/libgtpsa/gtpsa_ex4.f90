...
program gtpsa_ex4
  ...
  d=mad_desc_newvpo(6, 0_1, 0, 0_1, no)
  print *, "d10 length=", mad_desc_maxlen(d, mad_tpsa_default), "coefs"
  ...
  d=mad_desc_newvpo(6, 12_1, 0, 0_1, no)
  print *, "d   length=", mad_desc_maxlen(d, mad_tpsa_default), "coefs"
