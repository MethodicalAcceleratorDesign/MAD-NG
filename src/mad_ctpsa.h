...
num_t    mad_ctpsa_density (const ctpsa_t *t, num_t stat_[2], log_t reset); // ratio nz/nc in [0] U [lo,hi] or stat
...
void     mad_ctpsa_erfcx   (const ctpsa_t *a, ctpsa_t *c);
void     mad_ctpsa_erfi    (const ctpsa_t *a, ctpsa_t *c);
void     mad_ctpsa_wf      (const ctpsa_t *a, ctpsa_t *c);
