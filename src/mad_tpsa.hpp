...
struct tpsa_ref : tpsa_base<tpsa_ref> {
  ...
  tpsa_ref& operator=(      num_t         a) { TRC("ref=num") mad_tpsa_clear(ptr()); mad_tpsa_set0(  ptr(), 0, a); return *this; }
...
struct tpsa : tpsa_base<tpsa> {
  ...
  tpsa& operator=(      num_t         a) { TRC("tpa=num") mad_tpsa_clear(ptr()); mad_tpsa_set0(  ptr(), 0, a); return *this; }
