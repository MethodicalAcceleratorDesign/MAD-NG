...
void   mad_mat_sympinv (const  num_t x[],                          num_t  r[],           size_t n);                         //  -J M' J
num_t  mad_mat_symperr (const  num_t x[],                          num_t  r[],           size_t n);                         //  M' J M - J
...
void   mad_cmat_sympinv(const cnum_t x[],                         cnum_t  r[],           size_t n);                         //  -J M' J
num_t  mad_cmat_symperr(const cnum_t x[],                         cnum_t  r[],           size_t n);                         //  M' J M - J
