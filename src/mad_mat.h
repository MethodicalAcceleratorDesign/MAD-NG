...
void   mad_cmat_rev     (      cnum_t x[],                                      ssz_t m, ssz_t n, int d);                //  cmat -> rev(cmat)
void   mad_cmat_center  (      cnum_t x[],                                      ssz_t m, ssz_t n, int d);                //  cmat ->cmat-<cmat>
void   mad_cmat_roll    (      cnum_t x[],                                      ssz_t m, ssz_t n, int mroll, int nroll); //  cmat ->cmat
void   mad_cmat_eye     (      cnum_t x[],                         cnum_t  v  , ssz_t m, ssz_t n, ssz_t ldx);            //  cmat ->cmat
void   mad_cmat_eye_r   (      cnum_t x[], num_t v_re, num_t v_im,              ssz_t m, ssz_t n, ssz_t ldx);            //  cmat ->cmat
