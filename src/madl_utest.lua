...
M.FAILURE_PREFIX = 'Unit test FAILURE: ' -- prefix string for failed tests      -- MAD
M.SUCCESS_PREFIX = 'Unit test SUCCESS: ' -- prefix string for successful tests finished early
M.SKIP_PREFIX    = 'Unit test SKIP:    ' -- prefix string for skipped tests


                                                                                -- MAD
M.USAGE=[[Usage: mad <your_test_suite.lua> [options] [testname1 [testname2] ... ]
Options:
...
----------------------------------------------------------------
    ...
    function M.LuaUnit:execOneFunction(className, methodName, classInstance, methodInstance)
        ...
        local node = self.result.currentNode
        local class_mt = classInstance and {__index=classInstance}              -- MAD
        ...
        for iter_n = 1, self.exeRepeat or 1 do
            ...
            -- ensure referencial transparency of classes                       -- MAD
            if class_mt then
